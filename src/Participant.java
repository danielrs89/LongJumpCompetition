public class Participant {
    ...
    public Participant(String name, int dorsalNumber, double bestRecord2000, double bestRecord2001,
            double bestRecord2002) {
        Name = name;
    ...
    public String toString() {
        return "Participante [Nombre=" + Name + ", Dorsal=" + dorsalNumber + ", Record 2000=" + bestRecord2000
                + ", Record 2001=" + bestRecord2001 + ", Record 2002=" + bestRecord2002 + "]";
    }
